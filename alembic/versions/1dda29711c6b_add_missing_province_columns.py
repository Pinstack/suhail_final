...
def upgrade() -> None:
    ...
    op.drop_index(op.f('idx_temp_qi_population_metrics_geometry'), table_name='temp_qi_population_metrics', postgresql_using='gist')
    op.drop_table('temp_qi_population_metrics')
    op.drop_index(op.f('idx_temp_metro_stations_geometry'), table_name='temp_metro_stations', postgresql_using='gist')
    op.drop_table('temp_metro_stations')
    op.drop_index(op.f('idx_temp_parcels_geometry'), table_name='temp_parcels', postgresql_using='gist')
    op.drop_table('temp_parcels')
    op.drop_index(op.f('idx_temp_subdivisions_geometry'), table_name='temp_subdivisions', postgresql_using='gist')
    op.drop_table('temp_subdivisions')
    op.drop_index(op.f('idx_temp_metro_lines_geometry'), table_name='temp_metro_lines', postgresql_using='gist')
    op.drop_table('temp_metro_lines')
    op.drop_index(op.f('idx_temp_riyadh_bus_stations_geometry'), table_name='temp_riyadh_bus_stations', postgresql_using='gist')
    op.drop_table('temp_riyadh_bus_stations')
    # op.drop_table('spatial_ref_sys')  # Commented out - required by PostGIS extension
    op.drop_index(op.f('idx_temp_neighborhoods_geometry'), table_name='temp_neighborhoods', postgresql_using='gist')
    op.drop_table('temp_neighborhoods')
    op.drop_index(op.f('idx_temp_qi_stripes_geometry'), table_name='temp_qi_stripes', postgresql_using='gist')
    op.drop_table('temp_qi_stripes')
    op.drop_index(op.f('idx_temp_bus_lines_geometry'), table_name='temp_bus_lines', postgresql_using='gist')
    op.drop_table('temp_bus_lines')
