...
def main():
    ...
    print(f"   python -m suhail_pipeline.cli province-geometric riyadh")
    print(f"   ")
    print(f"   # All Saudi Arabia")
    print(f"   python -m suhail_pipeline.cli saudi-arabia-geometric")
    print(f"   ")
    print(f"   # Efficient strategy for large areas")
    print(f"   python -m suhail_pipeline.cli saudi-arabia-geometric --strategy efficient")
