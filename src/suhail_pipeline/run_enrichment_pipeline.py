...
from suhail_pipeline.exceptions import ValidationException
from suhail_pipeline.logging_utils import get_logger
from suhail_pipeline.enrichment.strategies import (
...
from suhail_pipeline.enrichment.processor import fast_worker
from suhail_pipeline.enrichment.metrics_only_processor import metrics_only_worker
from suhail_pipeline.persistence.db import (
    get_async_db_engine,
    setup_database_async,
)
from suhail_pipeline.persistence.enrichment_persister import (
...
def smart_pipeline_enrich(
    ...
    if geometric_first:
        ...
        from suhail_pipeline.run_geometric_pipeline import main as run_geometric_pipeline
        import sys
